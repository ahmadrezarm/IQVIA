...
ComCliamEnrollDF['I502G'] = ((ComCliamEnrollDF['I502'] +ComCliamEnrollDF['I5020'] + ComCliamEnrollDF['I5021']+ComCliamEnrollDF['I5022']+ComCliamEnrollDF['I5023'] >0)& (ComCliamEnrollDF['I503G'] ==0) & (ComCliamEnrollDF['I504G'] ==0)).astype(int)
...
HF1502GDF = ComCliamEnrollDF.loc[(ComCliamEnrollDF['I502G'] == 1), :]

DirectComCliamEnrollDF = HF1502GDF
...
TotalInfoDF.to_csv('C:/Users/rakovski/Dropbox (Chapman)/HeartFailure/Data/HeartFailure/I502G_CostBreakdown_Summary.csv',
                   index=None)