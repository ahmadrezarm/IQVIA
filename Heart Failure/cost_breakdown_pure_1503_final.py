...
ComCliamEnrollDF['I503G'] = ((ComCliamEnrollDF['I503'] +ComCliamEnrollDF['I5030'] + ComCliamEnrollDF['I5031']+ComCliamEnrollDF['I5032']+ComCliamEnrollDF['I5033'] >0)& (ComCliamEnrollDF['I502G'] ==0) & (ComCliamEnrollDF['I504G'] ==0)).astype(int)
...
HF1503GDF = ComCliamEnrollDF.loc[(ComCliamEnrollDF['I503G'] == 1), :]

DirectComCliamEnrollDF = HF1503GDF
...
TotalInfoDF.to_csv('C:/Users/rakovski/Dropbox (Chapman)/HeartFailure/Data/HeartFailure/I503G_CostBreakdown_Summary.csv',
                   index=None)