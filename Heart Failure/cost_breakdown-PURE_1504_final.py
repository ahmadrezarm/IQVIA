...
ComCliamEnrollDF['I504G'] = ((ComCliamEnrollDF['I504'] +ComCliamEnrollDF['I5040'] + ComCliamEnrollDF['I5041']+ComCliamEnrollDF['I5042']+ComCliamEnrollDF['I5043'] >0)& (ComCliamEnrollDF['I503G'] ==0) & (ComCliamEnrollDF['I502G'] ==0)).astype(int)
...
HF1504GDF = ComCliamEnrollDF.loc[(ComCliamEnrollDF['I502G'] == 1), :]

DirectComCliamEnrollDF = HF1504GDF
...
TotalInfoDF.to_csv('C:/Users/rakovski/Dropbox (Chapman)/HeartFailure/Data/HeartFailure/I504G_CostBreakdown_Summary.csv',
                   index=None)